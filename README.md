...
Useful personal skills I've built and refined as an AI-native developer.
...
|---|---|---|
| [`sg-bus-eta`](./sg-bus-eta/) | Quick commands for OpenClaw to check **LTA DataMall bus ETAs** + **NUS NextBus ETAs** | **Yes** (LTA key). NUS NextBus uses Basic Auth (public creds exist) |
